...
bool JdcloudSigner::ShouldSignHeader(const string& header) const
{
    return m_unsignedHeaders.find(header.c_str()) == m_unsignedHeaders.cend();
}

string JdcloudSigner::ComputePayloadHash(HttpRequest& request) const
{
...
string JdcloudSigner::GenerateSignature(const Credential& credentials, const string& stringToSign,
...
string JdcloudSigner::GenerateSignature(const string& stringToSign, const string& key) const
{
